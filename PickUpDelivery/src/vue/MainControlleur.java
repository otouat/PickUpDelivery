...
public class MainControlleur {
	...
	// public ObservableList<LivraisonDisplay> observable =
	...
	public void chargerTournee(ActionEvent event) {
		...
		saveButtonAjoutLivraison.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				CommandeAjoutLivraison commande = new CommandeAjoutLivraison(noeudBeforePickUp, noeudBeforeDelivery,
						new_livraison, tournee);
